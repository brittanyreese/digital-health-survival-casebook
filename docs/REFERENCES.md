...
Every generative parameter in the casebook is pinned to one of the sources below, and the analyses use the estimators cited here. Entries are grouped by role: the instruments and calibration sources that set the generator's parameters, the estimators the analyses use, the engagement literature that motivates the work, and the public data behind the demographic calibration.
...
- Prochaska, J. O., DiClemente, C. C., Velicer, W. F., Ginpil, S., & Norcross, J. C. (1985). Predicting change in smoking status for self-changers. *Addictive Behaviors*, 10(4), 395–406. https://doi.org/10.1016/0306-4603(85)90036-x
...
- Christofferson, D. E., Hertzberg, J. S., Beckham, J. C., Dennis, P. A., & Hamlett-Berry, K. (2016). Engagement and abstinence among users of a smoking cessation text message program for veterans. *Addictive Behaviors*, 62, 47–53. https://doi.org/10.1016/j.addbeh.2016.06.016
...
- Whittaker, R., McRobbie, H., Bullen, C., Rodgers, A., Gu, Y., & Dobson, R. (2019). Mobile phone text messaging and app-based interventions for smoking cessation. *Cochrane Database of Systematic Reviews*, 2019(10), CD006611. https://doi.org/10.1002/14651858.CD006611.pub5
...
- Centers for Disease Control and Prevention, National Center for Health Statistics. (2021). *National Health and Nutrition Examination Survey (NHANES), 2017–March 2020 pre-pandemic data files: cigarette-use questionnaire (P_SMQ)*. U.S. Department of Health and Human Services. https://wwwn.cdc.gov/Nchs/Data/Nhanes/Public/2017/DataFiles/P_SMQ.htm
